    ...
    <>
      <Container fluid className="p-0">
        <div className="d-flex justify-content-center">
          <NavLink className="mx-3 fw-bold line p-2">
            Overview <BiSolidDownArrow className="arrow" />
          </NavLink>
          <NavLink className="mx-3 fw-bold p-2">
            Media <BiSolidDownArrow className="arrow" />
          </NavLink>
          <NavLink className="mx-3 fw-bold p-2">
            Fandom <BiSolidDownArrow className="arrow" />
          </NavLink>
          <NavLink className="mx-3 fw-bold p-2">
            Share <BiSolidDownArrow className="arrow" />
          </NavLink>
        </div>
        <div style={divStyle} className="mb-5">
          <Row className="bg align-items-center me-0" style={layoutColor}>
            <Col md="3" className="px-5 py-4">
              <img
                src={`${staticPathImg2}${movie.poster_path}`}
                className="img-de rounded-top"
              />
              <div></div>
            </Col>
            <Col md="9" className="px-5">
              <h2 className="text-white fw-bolder">
                {movie.title} <span className="text-light2">({year})</span>
              </h2>
              ...
              <div className="d-flex align-items-center">
                ...
                <span className="circle ms-4">
                  <MdFormatListBulleted className="options" />
                </span>
                <span
                ...
                >
                  <MdFavorite
                    className={`${isFavorite ? "options2" : "options"}`}
                  />
                </span>
                <span className="circle ms-4">
                  <BsFillBookmarkFill className="options" />
                </span>
                <span className="circle ms-4">
                  <AiFillStar className="options" />
                </span>
                <span className="ms-4 text-white">
                  <BiSolidRightArrow /> Play Trailer
                </span>
              </div>
              <div className="text-light my-3 fw-bold">{movie.tagline}</div>
